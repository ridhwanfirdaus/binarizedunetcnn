# -*- coding: utf-8 -*-
"""
Created on Sun Jan 31 17:01:11 2021
...
newinput = tf.keras.layers.Lambda(lambda x: x / 255)(inputs)

#contracting path  start 2 convolutional layers with feature space of 16 kernel size of 3x3
conv1 = tf.keras.layers.Conv2D(start_neuron * 1, (3,3),activation ='relu',kernel_initializer = 'he_normal', padding = 'same')(newinput)
conv1 = tf.keras.layers.Dropout(0.1)(conv1)
conv1 = tf.keras.layers.Conv2D(start_neuron * 1,(3,3), activation ='relu', kernel_initializer = 'he_normal', padding ='same')(conv1)
...
checkpointer = tf.keras.callbacks.ModelCheckpoint('model_pet.h5', verbose = 1, save_best_only = True )
...
prediction_val = model.predict(XTrain[int(XTrain.shape[0]*0.9):], verbose = 1)
